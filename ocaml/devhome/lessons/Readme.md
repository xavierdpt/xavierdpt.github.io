...
```
* [Lesson 22: Storing the preference in a hash table](ce7d422878df22b8fdbbb6caf9f779a0)
```
let () = let niterations : int = try int_of_string Sys.argv.(1) with
                | _ -> print_endline "Invalid argument, setting number of iterations to default value 2" ; 2
        and pfe : bool = Sys.file_exists ".preferences"
...
```
* [Lesson 23: Reading all the lines](f29478f3e4850efc9ec91b87179fe342)
```
let () = let niterations : int = try int_of_string Sys.argv.(1) with
                | _ -> print_endline "Invalid argument, setting number of iterations to default value 2" ; 2
        and pfe : bool = Sys.file_exists ".preferences"
...
```
* [Lesson 24: Generating random numbers](d7d29b7d11b98a833c7575494e0e8f01)
```
...
```
* [Lesson 25: Accessing environment variables](07a4b99ef333c5dc2c0d13458f334f80)
```
let () = Random.self_init ();
        let niterations : int = try int_of_string Sys.argv.(1) with
