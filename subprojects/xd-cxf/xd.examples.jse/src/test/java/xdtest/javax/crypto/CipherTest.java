...
public class CipherTest {
    @Test
    public void test() throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException, InvalidKeyException, InvalidAlgorithmParameterException, ShortBufferException, IllegalBlockSizeException, BadPaddingException {
        if (TestUtils.scaffold()) {
            Cipher instance = TestUtils.makeInstance(Cipher.class);
