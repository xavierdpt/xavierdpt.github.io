...
import net.xdexamples.jse.examples.javax.xml.parsers.SAXParserFactoryExample;
...
@ExampleIndex({
        ...
        DocumentBuilderExample.class,

        DocumentBuilderFactory.class,
        DocumentBuilderFactoryExample.class,
        ...
        SAXParser.class,
        SAXParserExample.class,

        SAXParserFactory.class,
        SAXParserFactoryExample.class
})
public class Index {
